...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');"> 
  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      ...
      <div id="logo" class="fl_left">
        <h1><a href="index.html">Bead Art by Sabine</a></h1>
      </div>
      <!-- ################################################################################################ -->
  ...
  <div class="wrapper">
    <div id="pageintro" class="hoc clear"> 
      ...
      <article>
        <div>
          <p class="heading">Creative and Unique Designs</p>
          <h2 class="heading">Hand Made Art</h2>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="group">
      ...
      <div class="one_half"><img class="inspace-10 borderedbox" src="images/3117.jpeg" alt=""></div>
    </div>
    <!-- ################################################################################################ -->
    <!-- / main body -->
    <div class="clear"></div>
